  ...
  <section class="page-hero">
    ...
    <div class="container">
      ...
      <div class="page-hero__content">
        <span class="eyebrow eyebrow--white">Custom Development</span>
        <h1>Custom Safety Apps & Software Solutions</h1>
        <p>Purpose-built for your workflow, deployed on any device. From mobile inspection apps to full HSE management systems — developed using Power Apps, web technologies, and proven HSE domain expertise.</p>
        <div class="page-hero__actions">
          
          <a href="book-consultation.html" class="btn btn-gold btn-lg"><i class=""></i> Discuss Your App</a>
...
`,u={range:`<span class="from">From</span>$8k <em>—</em> $60k+`,description:`Single-form Power Apps (e.g. mobile inspection, hazard reporting, permit-to-work) typically run $8k–$15k. Multi-flow apps with dashboards and back-end integrations land $25k–$60k+. Power Platform builds usually ship faster than custom code.`,entryNote:`Free workflow walkthrough before scoping`};function d(){(0,s.useEffect)(()=>{document.title=`Custom Safety Apps & Software Solutions | Ansar Mahmood`},[]);let[e,t]=o(l);return(0,c.jsxs)(c.Fragment,{children:[(0,c.jsx)(r,{route:`safety-apps`,icon:`fa-mobile-screen`}),(0,c.jsx)(i,{html:e.slice(e.indexOf(`</section>`)+10)}),(0,c.jsx)(a,{investment:u,ctaLabel:`Free workflow walkthrough`}),t&&(0,c.jsx)(i,{html:t})]})}export{d as default};