...
`,u={range:`<span class="from">From</span>$95 <em>—</em> $1.4k <span class="from">/ delegate</span>`,description:`Open-cohort certification courses (IOSH MS, ISO Lead Auditor, etc.) typically run $95–$1,400 per delegate depending on length and credential. Corporate in-house programs are quoted by group size with discounts above 12 attendees.`,entryNote:`Free 30-min training-needs call before quoting`},d={headers:[``,`Generic Trainer`,`Online-Only Provider`,`Ansar Mahmood`],winnerIndex:3,rows:[[`97%+ first-attempt pass rate`,!1,`Varies`,!0],[`Live coaching + recorded materials`,`Sometimes`,!1,!0],[`Hands-on field examples in delivery`,`Limited`,!1,!0],[`Cohort + 1:1 coaching mix`,!1,!1,!0],[`Post-exam mentoring`,!1,!1,`Included`],[`Custom corporate cohorts`,`Sometimes`,`Limited`,!0]]},f=[`Confined Space Entry`,`Working at Height`,`Manual Handling`,`Chemical Spill Response`,`Lifting, Rigging & Slinging`,`Permit to Work`,`Fire Warden / Marshal`,`Hazard Identification`,`Behaviour-Based Safety`,`Accident & Incident Investigation`,`PPE & Respiratory Protection`,`Electrical Safety`,`Scaffolding Awareness`,`Heat & Cold Stress`,`H2S Awareness`,`Defensive Driving`,`Environmental Awareness`,`Toolbox Talks`,`Emergency Response & Evacuation`,`Noise & Vibration`,`COSHH & Hazardous Substances`,`Office & Ergonomics Safety`].map((e,t)=>`<span class="topic-chip" style="--d:${t%12*.04}s"><i class="fas fa-check"></i>${e}</span>`).join(``);function p(){(0,s.useEffect)(()=>{document.title=`HSE Training Programs | Ansar Mahmood — Corporate, Online & On-site Delivery`},[]);let[e,t]=o(l.replace(`{%topics%}`,f));return(0,c.jsxs)(c.Fragment,{children:[(0,c.jsx)(r,{html:e.slice(0,e.indexOf(`</section>`)+10)}),(0,c.jsx)(a,{src:`assets/images/poster-training.png`,alt:`Training Services by Ansar Mahmood`}),(0,c.jsx)(r,{html:e.slice(e.indexOf(`</section>`)+10)}),(0,c.jsx)(i,{investment:u,comparison:d,ctaLabel:`Free training-needs call`}),t&&(0,c.jsx)(r,{html:t})]})}export{p as default};