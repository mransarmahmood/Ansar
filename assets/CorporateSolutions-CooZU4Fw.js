...
`,l={range:`<span class="from">From</span>$4k <em>/ month</em>`,description:`Corporate partnerships typically start at $4k/month for a fractional-HSE retainer (8–12 advisory days/month) and scale with consulting, training, and digital deliverables bundled in. Quarterly statements of work keep scope flexible without long lock-ins.`,entryNote:`Pilot-quarter option keeps the first 90 days low-risk`},u={headers:[``,`Hire FTE HSE Director`,`Big-4 Consultancy`,`Ansar Partnership`],winnerIndex:3,rows:[[`Senior credentials from day one`,`Possible`,!0,!0],[`Cost of a single FTE`,`$120k+ / yr`,`$300k+ / yr`,`$48k+ / yr`],[`Scales up & down with project load`,!1,`Slow`,!0],[`Hands-on delivery (not just decks)`,`Yes`,!1,!0],[`Digital + AI tooling under the same SOW`,!1,`Add-on`,!0],[`Trains your internal team along the way`,`Sometimes`,!1,!0]]};function d(){(0,o.useEffect)(()=>{document.title=`End-to-End Corporate HSE Solutions | Ansar Mahmood`},[]);let[e,t]=a(c);return(0,s.jsxs)(s.Fragment,{children:[(0,s.jsx)(r,{html:e}),(0,s.jsx)(i,{investment:l,comparison:u,ctaLabel:`Discuss enterprise partnership`}),t&&(0,s.jsx)(r,{html:t})]})}export{d as default};