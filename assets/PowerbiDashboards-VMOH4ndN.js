...
`,l={range:`<span class="from">From</span>$3.5k <em>—</em> $25k+`,description:`A single-source HSE Power BI dashboard typically lands $3.5k–$8k. Multi-source enterprise builds (data gateway, role-level security, mobile reports) range $12k–$25k+. Pricing scales with the number of data sources and the breadth of stakeholders consuming reports.`,entryNote:`Free 30-min dashboard scoping call`};function u(){(0,o.useEffect)(()=>{document.title=`Real-Time HSE Power BI Dashboards | Ansar Mahmood`},[]);let[e,t]=a(c);return(0,s.jsxs)(s.Fragment,{children:[(0,s.jsx)(r,{html:e}),(0,s.jsx)(i,{investment:l,ctaLabel:`Free dashboard scoping call`}),t&&(0,s.jsx)(r,{html:t})]})}export{u as default};