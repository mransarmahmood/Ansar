...
`,l={range:`<span class="from">From</span>$8k <em>—</em> $60k+`,description:`Single-form Power Apps (e.g. mobile inspection, hazard reporting, permit-to-work) typically run $8k–$15k. Multi-flow apps with dashboards and back-end integrations land $25k–$60k+. Power Platform builds usually ship faster than custom code.`,entryNote:`Free workflow walkthrough before scoping`};function u(){(0,o.useEffect)(()=>{document.title=`Custom Safety Apps & Software Solutions | Ansar Mahmood`},[]);let[e,t]=a(c);return(0,s.jsxs)(s.Fragment,{children:[(0,s.jsx)(r,{html:e}),(0,s.jsx)(i,{investment:l,ctaLabel:`Free workflow walkthrough`}),t&&(0,s.jsx)(r,{html:t})]})}export{u as default};