...
`,u={range:`<span class="from">From</span>$6k <em>—</em> $35k+`,description:`A focused HSE intranet site (document hub + register lists) typically runs $6k–$12k. Full enterprise portals with permit-to-work, contractor management, and Teams/Power Platform integrations range $20k–$35k+.`,entryNote:`Free portal-architecture call before scoping`};function d(){(0,s.useEffect)(()=>{document.title=`SharePoint HSE Portals & Document Management | Ansar Mahmood`},[]);let[e,t]=o(l);return(0,c.jsxs)(c.Fragment,{children:[(0,c.jsx)(r,{route:`sharepoint-solutions`,icon:`fa-folder-tree`}),(0,c.jsx)(i,{html:e.slice(e.indexOf(`</section>`)+10)}),(0,c.jsx)(a,{investment:u,ctaLabel:`Free portal-architecture call`}),t&&(0,c.jsx)(i,{html:t})]})}export{d as default};