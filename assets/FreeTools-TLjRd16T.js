...
`;function c(){(0,a.useEffect)(()=>{document.title=`Free HSE Tools & Calculators — Risk, Incident Rate & Safety Metrics | Ansar Mahmood`},[]);let e=s.indexOf(`</section>`)+10;return(0,o.jsxs)(o.Fragment,{children:[(0,o.jsx)(r,{route:`free-tools`,icon:`fa-toolbox`}),(0,o.jsx)(i,{html:s.slice(e)})]})}export{c as default};