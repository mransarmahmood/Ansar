...
`,u={range:`<span class="from">From</span>$3.5k <em>—</em> $25k+`,description:`A single-source HSE Power BI dashboard typically lands $3.5k–$8k. Multi-source enterprise builds (data gateway, role-level security, mobile reports) range $12k–$25k+. Pricing scales with the number of data sources and the breadth of stakeholders consuming reports.`,entryNote:`Free 30-min dashboard scoping call`};function d(){(0,s.useEffect)(()=>{document.title=`Real-Time HSE Power BI Dashboards | Ansar Mahmood`},[]);let[e,t]=o(l);return(0,c.jsxs)(c.Fragment,{children:[(0,c.jsx)(r,{route:`powerbi-dashboards`,icon:`fa-chart-line`}),(0,c.jsx)(i,{html:e.slice(e.indexOf(`</section>`)+10)}),(0,c.jsx)(a,{investment:u,ctaLabel:`Free dashboard scoping call`}),t&&(0,c.jsx)(i,{html:t})]})}export{d as default};