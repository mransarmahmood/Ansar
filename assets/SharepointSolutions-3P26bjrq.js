...
`,l={range:`<span class="from">From</span>$6k <em>—</em> $35k+`,description:`A focused HSE intranet site (document hub + register lists) typically runs $6k–$12k. Full enterprise portals with permit-to-work, contractor management, and Teams/Power Platform integrations range $20k–$35k+.`,entryNote:`Free portal-architecture call before scoping`};function u(){(0,o.useEffect)(()=>{document.title=`SharePoint HSE Portals & Document Management | Ansar Mahmood`},[]);let[e,t]=a(c);return(0,s.jsxs)(s.Fragment,{children:[(0,s.jsx)(r,{html:e}),(0,s.jsx)(i,{investment:l,ctaLabel:`Free portal-architecture call`}),t&&(0,s.jsx)(r,{html:t})]})}export{u as default};