...
`,u={range:`<span class="from">From</span>$3k <em>—</em> $20k+`,description:`A focused single-site gap analysis or ISO 45001 readiness audit typically lands between $3k and $12k. Multi-site programs and certification-stage audits scale up from there. Most clients pair the audit with a remediation plan.`,entryNote:`Single-day diagnostic available from $2k`},d={headers:[``,`Self-audit`,`Generic Auditor`,`Ansar Mahmood`],winnerIndex:3,rows:[[`ISO 45001 Lead Auditor credential`,!1,`Sometimes`,!0],[`Sector-specific risk insight`,!1,`Limited`,!0],[`Findings tied to a remediation plan`,!1,!1,!0],[`Board-ready report`,!1,`Sometimes`,!0],[`Ongoing support after the audit`,!1,!1,!0]]};function f(){(0,s.useEffect)(()=>{document.title=`HSE Audits & Gap Analysis | Ansar Mahmood — ISO Compliance Audit Services`},[]);let[e,t]=o(l);return(0,c.jsxs)(c.Fragment,{children:[(0,c.jsx)(r,{route:`audits`,icon:`fa-clipboard-check`}),(0,c.jsx)(i,{html:e.slice(e.indexOf(`</section>`)+10)}),(0,c.jsx)(a,{investment:u,comparison:d,ctaLabel:`Free audit-readiness call`}),t&&(0,c.jsx)(i,{html:t})]})}export{f as default};